...
<div class="block myaccount">
	...
	<div class="block_content">
		<ul class="bullet">
			...
			{if $returnAllowed}<li><a href="{$link->getPageLink('order-follow', true)}" title="{l s='My returns' mod='blockmyaccountfooter'}" rel="nofollow">{l s='My returns' mod='blockmyaccountfooter'}</a></li>{/if}
