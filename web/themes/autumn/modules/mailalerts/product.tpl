...
<div class="product_mail_alerts">
    {if isset($email) AND $email}
            <input type="text" id="oos_customer_email" name="customer_email" value="{l s='your@email.com' mod='mailalerts'}" class="mailalerts_oos_email light" onclick="clearText();" />
    {/if}
    <a class="autumn-button" href="#" onclick="return addNotification();" id="mailalert_link">{l s='Notify me when available' mod='mailalerts'}</a>
