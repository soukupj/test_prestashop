...
<div id="favoriteproducts_block_account">
	<h1 class="dotted_bottom">{l s='My favorite products' mod='favoriteproducts'}</h1>
	{if $favoriteProducts}
		<div>
	...
	<ul class="footer_links">
		<li class="fleft">
			<a class="back_account_link" href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}">{l s='Back to Your Account' mod='favoriteproducts'}</a>
                </li>
	</ul>
</div>