...
{if !$opc}<h1 class="dotted_bottom">{l s='Please choose your payment method'}</h1>{else}<h2><span>3</span> {l s='Please choose your payment method'}</h2>{/if}
...
{/if}   
        <h3 class="title">{l s='Select your payment method'}</h3>
