<!-- Autumn Theme Search Block -->
<div id="search_block_left" class="block exclusive">
	<h4>{l s='Search' mod='autumnsearchblock'}</h4>
	<form method="get" action="{$link->getPageLink('search', true)}" id="searchbox">
		<p class="block_content">
			<label for="search_query_block">{l s='Enter a product name' mod='autumnsearchblock'}</label>
			...
			<input type="submit" id="search_button" class="button_mini" value="{l s='go' mod='autumnsearchblock'}" />
		</p>
	</form>
</div>
