...
<h1 class="dotted_bottom">{l s='Our stores'}</h1>
...
{else}
	...
	<h4>{l s='Enter a location (e.g. zip / postal code, address, city or country) in order to find the nearest stores.'}</h4><br />
	<p class="store_input">
		<label for="addressInput">{l s='Your location:'}</label>
		<input type="text" class="light" name="location" id="addressInput" value="{l s='Address, zip/postal code, city, state or country'}" onclick="this.value='';" />
        </p>
        <p class="store_input">
