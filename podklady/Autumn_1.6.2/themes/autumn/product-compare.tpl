...
//]]>
	...
	<form class="product_compare_form" method="post" action="{$link->getPageLink('products-comparison')}" onsubmit="true">
		<p>
		<input type="submit" class="autumn-button" value="{l s='Compare'}" />
