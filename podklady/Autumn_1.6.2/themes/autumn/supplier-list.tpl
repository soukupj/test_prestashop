...
{if $nbSuppliers > 0}
	...
	<ul id="suppliers_list" class="grid">
		...
		<li class="clearfix {if $supplier@first}first_item{elseif $supplier@last}last_item{else}item{/if}">
			<div class="left_side">
                ...
                {* START - Autumn Theme Retro Compatibility Edits *}
					<img src="{$img_sup_dir}{$supplier.id_supplier|escape:'htmlall':'UTF-8'}-medium_default.jpg" alt="" width="{$mediumSize.width}" height="{$mediumSize.height}" />
