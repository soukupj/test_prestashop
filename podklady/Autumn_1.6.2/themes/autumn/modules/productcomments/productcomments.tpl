			...
			<div class="comment clearfix">
				<div class="comment_author">
					...
					<div class="comment_author_infos">
						<span class="comment_author_span">{$comment.customer_name|escape:'html':'UTF-8'}</span><br/>
						<span class="comment_date_span">{dateFormat date=$comment.date_add|escape:'html':'UTF-8' full=0}</span>
					</div>
				</div>
		...
		<form action="#">
			...
			<div class="new_comment_form_content">
				...
				<div id="new_comment_form_footer">
					...
					<p class="fr">
						<input id="submitNewMessage" name="submitMessage" type="submit" class="button" value="{l s='Send' mod='productcomments'}"></input>&nbsp;
