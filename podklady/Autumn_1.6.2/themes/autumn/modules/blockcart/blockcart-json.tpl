...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		"name":          "{$product.name|html_entity_decode:2:'UTF-8'|truncate:27:'...':true|escape:'htmlall'}",
		"title":         "{$product.name|html_entity_decode:2:'UTF-8'|escape:'htmlall'}",
		...
		"price_float":   "{$product.total}",
                ...
                {*<add:Product Image>*}
                    "id_image":      "{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')}",
                {*</add>*}
